...
if (!args[0]) throw `*[❗𝐈𝐍𝐅𝐎❗] الرجاء ارس الرابط بشكل صحيح: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/` 
if (!args[0].match(/www.facebook.com|fb.watch/g)) throw `*[❗𝐈𝐍𝐅𝐎❗] الرجاء ارسل الرابط بشكل صحيح: ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/`
try {
await m.reply(`*[❗] سيتم التحميل الحين يرجوا الانتظار من دقيقتين الى 10 دقايق...*`)      
